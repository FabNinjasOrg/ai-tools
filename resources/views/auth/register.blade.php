<x-face-finder.layout.guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="mb-6">
            <x-input-label for="name" :value="__('Full Name')" class="text-sm font-semibold text-slate-700 mb-2" />
        ...
        <!-- Confirm Password -->
        <div class="mb-6">
            <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="text-sm font-semibold text-slate-700 mb-2" />
